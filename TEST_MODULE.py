...
def generate_legned(SNPs=24,depth=0.1):
    """ Generates a random legend for the reference panel. """
    chr_id = 'chrTEST'
...
def generate_haplotype(groups=1,SNPs=24,number_of_haplotypes=10):
    """ Generates a random reference panel of haplotypes."""
...
def generate_obs(legend,alleles_per_read=4):
    """ Generates a random list of observed alleles."""
...
def generate_sam(groups=1,number_of_haplotypes=10):
    """ Generates a random list of samples that their phased haplotypes form the reference panel. """
    sam_tab = {}
...
def print_haplotypes(hap_tab,number_of_haplotypes):
    """ Returns the reference panel in a readable format. """
...
if __name__=="__main__":
    ...
    print("Done generating a test reference panel as well as a test observation file.\n")
    print("- You can use the test files generated by executing the following command:")
    print("python ANEUPLOIDY_TEST.py test/test.obs.p test/test.leg.p test/test.hap.p group0")
